  ...
  return (
    <div className="fixed inset-0 -z-10">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div 
          className="absolute top-20 left-1/4 w-96 h-96 rounded-full opacity-12 blur-3xl"
          style={{
        ...
        />
        <div 
          className="absolute bottom-32 right-1/4 w-80 h-80 rounded-full opacity-18 blur-2xl"
          style={{
            background: 'radial-gradient(circle, rgba(139, 69, 19, 0.5) 0%, rgba(255, 140, 0, 0.3) 50%, transparent 70%)',
            transform: `translate(${scrollY * -0.03}px, ${scrollY * 0.02}px) scale(${1 + scrollY * 0.0001})`
          }}
        />
        <div 
          className="absolute top-1/2 right-16 w-72 h-72 rounded-full opacity-15 blur-3xl"
          style={{
            background: 'radial-gradient(circle, rgba(168, 85, 247, 0.4) 0%, rgba(59, 130, 246, 0.3) 50%, transparent 70%)',
            transform: `translate(${scrollY * 0.04}px, ${scrollY * -0.02}px) scale(${1 + scrollY * 0.0001})`
          }}
        />
        <div 
          className="absolute top-32 left-16 w-64 h-64 rounded-full opacity-14 blur-2xl"
          style={{
            background: 'radial-gradient(circle, rgba(16, 185, 129, 0.4) 0%, rgba(34, 197, 94, 0.3) 50%, transparent 70%)',
            transform: `translate(${scrollY * -0.02}px, ${scrollY * 0.04}px) scale(${1 + scrollY * 0.0001})`
          }}
        />
        <div 
          className="absolute bottom-1/4 left-1/3 w-56 h-56 rounded-full opacity-16 blur-3xl"
          style={{
            background: 'radial-gradient(circle, rgba(239, 68, 68, 0.3) 0%, rgba(251, 146, 60, 0.4) 50%, transparent 70%)',
